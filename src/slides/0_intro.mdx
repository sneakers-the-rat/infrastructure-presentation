...
<Box width={1/4}
  ...
  width={1/3}
>What<br/>computer<br/>do?</Heading></Box>


<PositionedCard
    id={'experiment-card'} x={300} y={600} width={1/4}
  title={"Controlling Experiments"}
  body={"we do it all the time!!! Seriously cant keep us away from it!"}/>

<PositionedCard
    id={'data-card'} x={1400} y={300} width={1/4}
    title={"Store & Analyze Data"}
    body={"Can you believe it! there's a big hunk of it!"}/>

<PositionedCard
    id={'share-card'} x={800} y={50} width={1/4}
    title={"Share & Communicate"}
    body={"Gotta put everything somewhere!!!"}/>
