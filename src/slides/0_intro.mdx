...
<Box width={1/3}><Heading
  textAlign={'left'}
  id={"computers-heading"}
  width={1/3}
>What do we use computers for all day?</Heading></Box>


<PositionedCard
    id={'analysis-card'} x={500} y={500} width={1/3}
  title={"Data Analysis!"}
  subtitle={'programmin it'}
  body={"we do it all the time!!!"}/>
