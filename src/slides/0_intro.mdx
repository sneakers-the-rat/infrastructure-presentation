...
<Grid gridTemplateColumns={'1fr 1fr'} gridColumnGap={"40px"} marginTop={"40px"}>
  <Appear stepIndex={2} id={'impacts-1'}><Heading fontSize={"h3"} color={"tools"} fontWeight={200}>Personally...</Heading></Appear>
  <Appear stepIndex={3} id={'impacts-2'}><Heading fontSize={"h3"} color={"tools"} fontWeight={200} >Systemically...</Heading></Appear>
  <Appear stepIndex={2} id={'impacts-3'}><VerticalLinearStepper
  steps={[
    {
  ...
  /></Appear>
  <Appear stepIndex={3} id={'impacts-4'}>
  <VerticalLinearStepper
      steps={[
        {
          title: 'Undone labor of infrastructure falls disproportionately on Early Career Researchers',
          body: '',
        },
        {
